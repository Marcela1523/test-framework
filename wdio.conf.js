...
var featureFiles;
var appName;
if(globalSettings.APP_NAME == 'STORE'){
    featureFiles = './features/**/Store*.feature';
    appName = globalSettings.STORE_NAME;
} else {
    featureFiles = './features/**/Demo*.feature';
    appName = globalSettings.DEMO_NAME;
}
...
exports.config = {
    ...
    capabilities: [{
        ...
        'appium:deviceName': 'Nita2',
        'appium:platformVersion': '8.0',
        'appium:orientation': 'PORTRAIT',
        'appium:automationName': 'UiAutomator2',
        'appium:app': join(process.cwd(), '/resources/', appName),
        'appium:noReset': true,
